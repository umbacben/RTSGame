...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ARTSCamera_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ARTSCamera_Statics::PropPointers),
		0,
		0x009002A0u,
		METADATA_PARAMS(Z_Construct_UClass_ARTSCamera_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ARTSCamera_Statics::Class_MetaDataParams))
	};
